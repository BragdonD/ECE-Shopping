...
public class AppStyles {
        ...
        "-fx-border-width: 1px;"+
        "-fx-width: 100%; -fx-max-width: 250px ; -fx-padding: 5px; -fx-text-alignment: left; -fx-font-size: 14px; -fx-text-fill: #000000;";
        ...
        public static final String LABEL_STYLE = "-fx-font-size: 11px; -fx-font-weight: bold; -fx-text-fill: #000000; -fx-padding: 0 0 1px 0; -fx-text-alignment: center; -fx-wrap-text: true; -fx-width: 100%;";
