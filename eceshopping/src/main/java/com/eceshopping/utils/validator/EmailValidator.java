...
public class EmailValidator implements Validator {
    ...
    public static final String EMAIL_REGEX = "^[A-Za-z0-9+_.-]+@(.+)$"; // The regex to validate an email address
    ...
    /**
     * This method is used to get the errors of an email address.
     * 
     * @param email the email address to validate
     * @return a list of errors. If the email is valid, the list is empty.
     */
    @Override
